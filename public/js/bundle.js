...
module.exports = {
  ...
  "_spec": "axios@^0.21.1",
  "_where": "C:\\Users\\ZASASES\\Documents\\GitHub\\official-Art-Modifiers",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
exports.getMyAccount = exports.signUp = exports.login = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            console.log(_context.t0); //  showAlert('error', err.respose.data.message);
...
var signUp = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(userName, email, password, passwordConfirm) {
    var res;
...
var getMyAccount = /*#__PURE__*/function () {
...
var blog_message = document.querySelector(".blog");
var clothing_message = document.querySelector(".clothing");
var showMessage = document.querySelector(".blog-clothing"); //const checkBox = document.querySelector(".navigation_check_button");
//const lists = document.querySelector(".aboutArtM").href;

var navigation_bar = document.querySelector(".burger");
var navigation_lists = document.querySelector(".navigation-lists");
var form = document.querySelector(".form-signup ");
var loginForm = document.querySelector(".form-login");
var deletePost1 = document.querySelector("a.delete");
var myAccount = document.querySelector("a.getMyAccs");
var userDataForm = document.querySelector(".form-user-data");
var blog = document.querySelector(".blog-single-container");
var createBlogForm = document.querySelector(".formCreate");
...
document.querySelectorAll(".navigation-lists li a").forEach(function (link) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              (0, _auth.signUp)(userName, email, password, passwordConfirm);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              console.log("you are attempting to login with ".concat(email, " and ").concat(password));
...
if (deletePost1) {
  deletePost1.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var deleteBlog, res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.prev = 1;
            deleteBlog = "/artmodifiers/blog/blogs/".concat(deletePost1.dataset.doc);
            _context3.next = 5;
            return (0, _axios.default)({
              method: "DELETE",
              url: deleteBlog
          ...
          case 5:
            ...
            if (res.data.status === undefined) {
              (0, _alerts.showAlert)("success", "Blog deleted successfully!");
              window.setTimeout(function () {
                location.assign("/artmodifiers/blogs");
              }, 1500);
            }
          ...
          case 9:
            ...
            (0, _alerts.showAlert)("error", _context3.t0.response.data.message); // showAlert("error", 'Your are Not Authorised to Delete');
